...
test('catalog includes all registered molecule types', () => {
  expect([...MOLECULE_TYPES]).toEqual(['card', 'stat', 'note', 'data-table', 'select', 'tabs', 'esri:map', 'esri:legend', 'esri:layer-list', 'esri:time-slider', 'entity-detail', 'esri:feature-table'])
})
